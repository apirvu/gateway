...
//            init(config1);
    ...
    private GatewayConfiguration createGatewayConfigBuilder(String acceptClusterLink,
                                                            ...
                                                            String wsbindPort,
                                                            String servicePort) {
        String balancerURI1 = "ws://localhost:9090";
...
//                  .property("welcome-file", "index.html")
                ...
                .security()
                  .realm()
                    ...
                    .loginModule()
                    .type("class:org.kaazing.gateway.transport.http.security.auth.ExpTokenCustomLoginModule")
                    .success("required")
                  .done()
                .done()
                .done()
    ...
    @Test
    @Specification({ "expSt.challenge.rejected.then.accepted" })
